<%@ Page Language="VB" AutoEventWireup="false" CodeFile="myclaims.aspx.vb" Inherits="_Default" %>
<meta charset="UTF-8">
...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
  ...
  <a href="myclaims.aspx" class="w3-bar-item w3-button w3-padding-large w3-Black">
...
<div class="w3-top w3-hide-large w3-hide-medium" id="myNavbar">
  ...
  <!-- myclaims Section -->
  <div class="w3-padding-64 w3-content" id="myclaims">
    <h2 class="w3-text-light-grey">My Claims</h2>
    <hr style="width:200px" class="w3-opacity">

 
  <!-- End myclaims Section -->
  </div>
